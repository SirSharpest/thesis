...
\begin{figure}[!ht]
  \centering
     \subfloat[First sub-figure\label{subfig-1:waterfall}]{%
       \includegraphics[width=\columnwidth]{./figures/wf1.png}
     }
     \\
     \subfloat[First sub-figure\label{subfig-2:waterfall}]{%
       \includegraphics[width=\columnwidth]{./figures/wf2.png}
     }
     \\
     \subfloat[First sub-figure\label{subfig-3:waterfall}]{%
       \includegraphics[width=\columnwidth]{./figures/wf3.png}
     }
